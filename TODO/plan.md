...
├── TODO/
│   └── plan.md                      # [NEW] ไฟล์แผนงานและ TODO Checklists
├── electron/
...
└── src/
    ├── components/
    │   ├── Sidebar.tsx              # Server switcher dropdown
    │   ├── Dashboard.tsx            # Live network & multi-server status
...
- [ ] **Build Check**: เรียกใช้คำสั่ง `npm run build` เพื่อตรวจสอบว่าไม่มี TypeScript / Bundling Errors
- [ ] **Multi-Server Test**: ลองสร้างและสลับสลับใช้งานระหว่างเซิฟเวอร์หลายตัว
- [ ] **Tunnels Test**: ทดสอบการใส่ Auth Token / Tunnel Token และสั่ง เปิด/ปิด Ngrok & Cloudflare
- [ ] **Plugins Test**: ค้นหาปลั๊กอินสดจากเว็บและทดลองกด 1-Click Install ลงโฟลเดอร์ `/plugins`
- [ ] **Java Test**: ตรวจเช็คสถานะ Java และปุ่ม Auto-Installer
